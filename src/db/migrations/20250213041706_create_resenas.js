...
exports.up = function (knex) {
	return knex.schema.createTable('reseñas', (table) => {
		...
		table.integer('proveedor_id').unsigned().references('usuario_id').inTable('usuarios').notNullable();
		table.integer('solicitante_id').unsigned().references('usuario_id').inTable('usuarios').notNullable();
